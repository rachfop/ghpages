...
def generate_endpoint_mutation(
    ...
    """
    Generate a GraphQL mutation string to create a new endpoint.

    Args:
        name (str): The name of the endpoint.
        template_id (str): The template ID of the endpoint.
        gpu_ids (str, optional): The GPU IDs of the endpoint. Defaults to "AMPERE_16".
        network_volume_id (str, optional): The network volume ID of the endpoint. Defaults to None.
        locations (str, optional): The locations of the endpoint. Defaults to None.
        idle_timeout (int, optional): The idle timeout of the endpoint. Defaults to 5.
        scaler_type (str, optional): The scaler type of the endpoint. Defaults to "QUEUE_DELAY".
        scaler_value (int, optional): The scaler value of the endpoint. Defaults to 4.
        workers_min (int, optional): The minimum number of workers for the endpoint. Defaults to 0.
        workers_max (int, optional): The maximum number of workers for the endpoint. Defaults to 3.

    Returns:
        str: A GraphQL mutation string to create a new endpoint.
    """
    input_fields = []
